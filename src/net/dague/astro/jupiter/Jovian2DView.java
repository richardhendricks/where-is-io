...
public class Jovian2DView extends SurfaceView implements SurfaceHolder.Callback {
	...
	private Jovian2DThread thread;
	private JovianCalculator calc;

	public Jovian2DView(Context context) {
		super(context);
		...
		thread = new Jovian2DThread(holder, getContext(), calc);
